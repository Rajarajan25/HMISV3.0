...
export function Price(props) {
  ...
  console.log("formikValues-->", formikValues.payments.service_pricing_by_staff);
  return (
          ...
          <div className="d-flex row">
            <div className="col-4">
              ...
              <div className="re_select">
                <SelectDropDown
                  className='input'
                  onChange={value => props.setFieldValue('payments.price_type', value.value)}
                ...
                <div className="d-flex row" key={i}>
                    ...
                    <div className="re_select">
                      <SelectDropDown
                        ...
                        onChange={value => {
                          ...
                          props.setFieldValue('payments.service_pricing_by_staff' + [i] + '.duration_minutes', value.value)}}
                  ...
                  <div className="col-3">
                    ...
                    <div className="re_select">
                      <SelectDropDown
                        className='input'
                        onChange={value => props.setFieldValue('payments.service_pricing_by_staff' + [i] + '.price_type', value.value)}
