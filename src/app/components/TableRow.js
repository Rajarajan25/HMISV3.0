                                        ...
                                        {row.map((item, i) => {
                                            return (
                                                <Draggable key={item.id} draggableId={item.id} index={i}>
                                                    {(provided) => (
                                                        <div className="d-flex drag_sel" ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps} key={i}>
        ...
        <ul className="newTask_1 row" >
            <li className="col-lg-8">
                <Link to="#" className="userLogoicon" >
                    ...
                    <input type="text" className="newTaskinput" name="name" id="" placeholder="Doctor name" ref={nameRef} />
                </Link>
            </li>
