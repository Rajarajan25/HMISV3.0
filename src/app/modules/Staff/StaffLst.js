                        ...
                        <ul>
                          {onfield.map(value => {
                            return (
                              ...
                              <>
                                <li>
                                  <Popup trigger={<button onClick={(event) => { handleClick(value.id)}}> {value.name}</button>} position="right center">
                                      ...
                                      <div className="d-inline-block">
                                        <div className="d-flex">
                                          ...
                                          <div className="userName d-flex mr-2">
                                            <span className="m-auto">{value.name}</span>
                                          </div>
...
export default Warper(StaffLst);