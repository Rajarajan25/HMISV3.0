...
export function ContentEventBook() {
  return (
    <div className="clearfix">
      <div className="event_detail pb-5 dummy">
        <div className="event-height">

          <p className="font_weight_bold font-size-20 mb-2 pb-3 d-none border-bottom">Details</p>

          <div className="d-flex w-100 flex-column patientPersoanlinfo">

            <div className="form-group">
              <label className="form-lable d-block">Name *</label>
              <input placeholder="Enter name" type="text" className="form-control font_weight_medium color_707070" name="" />
            </div>

            <div className="form-group">
              <label className="form-lable d-block">Visibility</label>
            ...
            <div className="form-group">
              <label className="form-lable mb-3 d-block">Description</label>
              <textarea placeholder="Description" type="text" className="form-control" name="description"> </textarea>
            </div>

            <div className="form-group">
              <label className="form-lable d-block">Picture & Color *</label>
              <ColorCode />
            </div>

            <div className="form-group">
              <label className="form-lable d-block">Event Link</label>
