...
import EditBreakTimings from './EditBreakTimings';
...
if(currentPatient)
{
  return(
    <div className="d-flex flex-column patientDetailsoverview">
          ...
          <Row>
            <Col md={4}>
              <div className="form-group border-bottom">
                ...
                <p className="form-control-static font_weight_medium color_707070">{currentPatient.sex}</p>
              </div>
            </Col>
            <Col md={4}>
              <div className="form-group border-bottom">
            ...
            <Col md={4}>
              <div className="form-group border-bottom">
                ...
                <p className="form-control-static font_weight_medium color_707070">{currentPatient.mobile_number}</p>
              </div>
            </Col>
          </Row>
          <Row>
      ...
      <Button
        type="submit"
        className="btn btn-primary sign-btn ml-15 h-77 font-weight-500 mt-6"    onClick={toggleDrawer('left', true)}>Edit Location</Button>
        <Drawer className="patientProfileinfo" anchor="right" open={state.left} onClose={toggleDrawer('left', false)}>
          <div className="py-5 px-10 overflow-auto">
            <Link to="#" className="closeDrawer" onClick={toggleDrawerClose}><span className="my-auto font-weight-500">X</span></Link>
            <EditBreakTimings />
          </div>
