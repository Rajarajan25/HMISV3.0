        ...
        <div className="w-100">
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="hair">
                  <i className="catIcon rounded-circle mr-4">H</i>
          ...
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="nail">
                  <i className="catIcon rounded-circle mr-4">N</i>
          ...
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="barber">
                  <i className="catIcon rounded-circle mr-4">B</i>
          ...
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="eyebrows">
                  <i className="catIcon rounded-circle mr-4">E</i>
          ...
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="tattoo">
                  <i className="catIcon rounded-circle mr-4">T</i>
          ...
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="gym">
                  <i className="catIcon rounded-circle mr-4">G</i>
          ...
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="waxing">
                  <i className="catIcon rounded-circle mr-4">W</i>
          ...
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="massage">
                  <i className="catIcon rounded-circle mr-4">M</i>
          ...
          <div className="d-inline-flex _2FwA">
              ...
              <label className="subCategory" for="personal">
                  <i className="catIcon rounded-circle mr-4">P</i>
