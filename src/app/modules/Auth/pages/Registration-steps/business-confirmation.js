...
export default function BusinessConfirmatoin() {
  ...
  return (
    ...
    <div class="busi_col">
      ...
      <h1 class="h1 color_3F4772 font-weight-600 d-flex my-auto"><span class="mr-3 mt-8"> Congrats!!! {currentUser.first_name} </span> <img src="/media/auth-screen/thumbs-up.svg" alt="thumbs-up" /></h1>      
