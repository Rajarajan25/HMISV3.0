...
`;
const initialValues = { name: '', billingAddress: '', size: 1, type: '', phone_country: '', phone_no: '', 'acceptTerms': false };
...
function Registration(props) {
  ...
  if (currentBusiness.size && !preloading) {
    currentBusiness.bussinessType = currentBusiness.name !== "" ? "business" : "personal";
    let selectedSize = business_size_options.find(bus => bus.value === currentBusiness.size);
    let selectedType = business_type_options.find(bus => bus.value === currentBusiness.type);
    let selectedPhone = options.find(bus => bus.value === currentBusiness.phone_country);
      ...
      <div className="business_info">
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            setSubmitting(true);
            values.billingAddress = googleAddress?.fulladdress||formValues?.billingAddress;
            values.name=value === "business"?values.name:"";
            values.size = size.value;
            values.type = type.value;
            values.phone_country = phone.value;
            formPrefill ? handleUpdateBisness(values) : handleAddBusiness(values);

          }}
        >
          {props => (

            <form className="form fv-plugins-bootstrap fv-plugins-framework" onSubmit={props.handleSubmit} onKeyDown={onKeyDown}>
              <div className="mb-2">
              ...
              <div className="form-group fv-plugins-icon-container d-flex " >
                ...
                <div className={value === "business" ? "col " : "col d-none"}>
                  ...
                  <Field
                    ...
                    type="text"
                    className={`form-control py-5 px-6 ${getInputClasses(props, "fullname")}`}
                    name="name" />
              ...
              <div className="d-flex fv-plugins-icon-container">
                  <div className="form-group col-6 p-0 d-flex coun_cde">
                    <div className="col">
                      <label class="form-label d-block" for="exampleForm.ControlInput1">Street</label>
                      <Field
                        type="text"
                        autoComplete="off"
                        className={"form-control py-5 px-6"}
                  ...
                  <div className="form-group col-6 d-flex coun_cde">
                    ...
                    <div className="col pr-0">
                      <label class="form-label d-block" for="exampleForm.ControlInput1">City*</label>
                      <Field
                        type="text"
                        autoComplete="off"
                        className={"form-control py-5 px-6"}
              ...
              <div className="d-flex fv-plugins-icon-container">
                <div className="form-group col-6 p-0 d-flex coun_cde">
                  <div className="col">
                    <label class="form-label d-block" for="exampleForm.ControlInput1">State*</label>
                    <Field
                      type="text"
                      autoComplete="off"
                      className={"form-control py-5 px-6"}
                ...
                <div className="form-group col-6 d-flex coun_cde">
                  <div className="col pr-0">
                    <label class="form-label d-block" for="exampleForm.ControlInput1">Postal code*</label>
                    <Field
                      type="text"
                      autoComplete="off"
                      className={"form-control py-5 px-6"}
              ...
              <LocationSearchInput callback={handleLocationChange} searchField="#ship-address" />
              ...
              <div className="d-flex fv-plugins-icon-container">
                ...
                <div className="form-group col-6">
                  ...
                  <Field
                    placeholder="Phone"
                    type="text"
                    className={`form-control py-5 px-6 ${getInputClasses(props, "username")}`} name="phone_no" />
              ...
              <div className="form-group d-flex ch-bx">
                ...
                {props.touched.acceptTerms && props.errors.acceptTerms ? (
                  <div className="fv-plugins-message-container">
                    <div className="fv-help-block">{props.errors.acceptTerms}</div>
                  </div>
                ) : null}
